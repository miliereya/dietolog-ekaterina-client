			...
			<div className={s.section} id='about'>
				...
				<div className='container'>
					<div className={s.top_wrapper}>
						...
						<div className={s.col_2}>
							...
							{worthies.map((w) => {
								return (
									<div key={w.text} className={s.worth}>
					...
					<div className='container'>
						<div className={s.for_who_col}>
							...
							<div className={s.for_who_enum}>
								...
								<div className={s.for_who_wrapper} id="who-i-don't-work-with">
				...
				<div className='container'>
					...
					<div className={s.btn_wrapper}>
						<Link href='/certificates' className={s.link}>
							{my_education}
						</Link>
						<Link
							href='/'
